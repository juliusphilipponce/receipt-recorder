...
export const ReceiptConfirmationModal: React.FC<ReceiptConfirmationModalProps> = ({
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm animate-fade-in">
            <div className="bg-gray-800/90 backdrop-blur-md rounded-2xl shadow-2xl max-w-5xl w-full max-h-[95vh] overflow-hidden border border-gray-700 flex flex-col">
                <form onSubmit={handleSubmit} className="flex flex-col h-full min-h-0">
                    {/* Header */}
                    <div className="flex-shrink-0 px-6 py-4 border-b border-gray-700 bg-gradient-to-r from-sky-500/20 to-blue-500/20">
                        <h2 className="text-2xl font-bold text-white">Confirm Receipt Details</h2>
                        <p className="text-gray-300 text-sm mt-1">Review and edit the extracted information</p>
                    </div>
                    ...
                    {/* Footer */}
                    <div className="flex-shrink-0 px-6 py-4 border-t border-gray-700 bg-gray-800/50 flex justify-end gap-3">
                        <button
                            type="button"
                            onClick={onCancel}
                            disabled={isLoading}
                        ...
                        <button
                            type="submit"
                            disabled={isLoading}
                            className="px-6 py-2 bg-gradient-to-r from-sky-500 to-blue-500 hover:from-sky-600 hover:to-blue-600 text-white rounded-lg font-medium transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
                        >
                            {isLoading ? (
                                <>
